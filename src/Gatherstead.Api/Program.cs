...
builder.Services.AddSingleton<IAgeBandService, AgeBandService>();
...
builder.Services.AddScoped<IHouseholdUserService, HouseholdUserService>();
...
builder.Services.AddScoped<ITaskPlanService, TaskPlanService>();
...
builder.Services.AddScoped<ITaskIntentService, TaskIntentService>();
