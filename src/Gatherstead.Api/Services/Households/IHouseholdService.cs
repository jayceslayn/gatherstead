...
{
    Task<BaseEntityResponse<IReadOnlyCollection<HouseholdDto>>> ListAsync(Guid tenantId, IEnumerable<Guid>? ids = null, CancellationToken cancellationToken = default);
