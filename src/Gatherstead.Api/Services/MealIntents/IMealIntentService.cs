...
public interface IMealIntentService
{
    ...
    Task<BaseEntityResponse<IReadOnlyCollection<MyMealDto>>> ListForMemberAsync(Guid tenantId, IEnumerable<Guid>? memberIds = null, DateOnly? fromDay = null, CancellationToken cancellationToken = default);
