...
This repository uses Azure-first architecture with a C# .NET API and a Vue 3 / Nuxt 3 web UI. For a comprehensive overview of the project's architecture, design principles, and implementation status, please refer to the documentation in the `docs/` directory.
