...
- **Tenant-aware filtering for dependent tables**: Query filters only apply when an entity exposes `TenantId`, leaving relationship and profile tables (e.g., `MemberRelationship`, `ContactMethod`, `Address`, `MemberAttribute`, `DietaryProfile`, `ChoreAssignment`) without first-class tenant scoping. Add `TenantId` (or enforce tenant filtering via the parent link) so multi-tenant isolation applies even when these tables are queried directly.【F:packages/db/GathersteadDbContext.cs†L108-L149】【F:packages/db/Entities/MemberRelationship.cs†L5-L14】【F:packages/db/Entities/ContactMethod.cs†L5-L13】【F:packages/db/Entities/Address.cs†L5-L17】【F:packages/db/Entities/MemberAttribute.cs†L5-L12】【F:packages/db/Entities/DietaryProfile.cs†L5-L14】【F:packages/db/Entities/ChoreAssignment.cs†L5-L13】
...
- **API and workflow alignment**: Now that lineage, contact data, attendance, and assignment structures exist, expose them through DTOs/services with validation and authorization hooks so guardianship and arbitration rules become enforceable behaviors rather than schema-only constructs.【F:packages/db/Entities/MemberRelationship.cs†L5-L14】【F:packages/db/Entities/EventAttendance.cs†L5-L18】【F:packages/db/Entities/StayIntent.cs†L6-L20】【F:packages/db/Entities/ChoreAssignment.cs†L5-L13】

## Implementation Status and Next Steps
- **Implemented**: Multi-tenant backbone with auditing, households and members (including dietary metadata), relationship graph, contact/addresses/attributes, dietary profiles, event scaffolding with meal planning, daily attendance, chore templates/tasks with assignments, and lodging intents with arbitration metadata are represented in the data model.【F:packages/db/Entities/Tenant.cs†L6-L15】【F:packages/db/Entities/HouseholdMember.cs†L7-L29】【F:packages/db/Entities/MemberRelationship.cs†L5-L14】【F:packages/db/Entities/ContactMethod.cs†L5-L13】【F:packages/db/Entities/Address.cs†L5-L17】【F:packages/db/Entities/MemberAttribute.cs†L5-L12】【F:packages/db/Entities/DietaryProfile.cs†L5-L14】【F:packages/db/Entities/Event.cs†L6-L20】【F:packages/db/Entities/MealPlan.cs†L6-L17】【F:packages/db/Entities/EventAttendance.cs†L5-L18】【F:packages/db/Entities/ChoreTemplate.cs†L6-L16】【F:packages/db/Entities/ChoreTask.cs†L7-L17】【F:packages/db/Entities/ChoreAssignment.cs†L5-L13】【F:packages/db/Entities/StayIntent.cs†L6-L20】
- **Planned**: Strengthen tenant scoping on dependent tables, add operational indexes/constraints, and surface the new lineage/contact/attendance/arbitration capabilities through API endpoints and workflows with validation and authorization to match guardian/admin needs.【F:packages/db/GathersteadDbContext.cs†L108-L149】【F:packages/db/Entities/MemberRelationship.cs†L5-L14】【F:packages/db/Entities/ContactMethod.cs†L5-L13】【F:packages/db/Entities/EventAttendance.cs†L5-L18】【F:packages/db/Entities/StayIntent.cs†L6-L20】
